...
$sql="update board1_img set hit=hit+1 where no={$no}";
...
<tr><th class='type06' width="20%">제목</th><td class='type06'><?=$arr['subject']?></td></tr>
...
onclick="location.href='rmftn.php?no=<?=$arr['no']?>'">

<input type='button' value='삭제'
onclick="location.href='del.php?no=<?=$arr['no']?>'">
<?php
}
}
?>
<input type='button' value='목록으로'
onclick="location.href='st.php'">
</div>
<br>
<!-- 댓글 작성 -->
<div align='center'>
<table class='type06' border='1' width='80%' align='center'>
<form method='POSt' action='eotrmf.php'>
<tr>
...
$sql="select no,writer,content,board_no from reply_img where board_no={$arr['no']}";
$result=mysqli_query($conn,$sql);
...
?>
<tr>
<form method='POST' action='eotk.php'>
...
<td><input class='button' type='submit' value='삭제'></td>
</tr>
</form>
<?php
}
