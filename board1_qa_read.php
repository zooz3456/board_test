...
$sql="update board1_qa set hit=hit+1 where no={$no}";
...
onclick="location.href='board1_qa_update.php?no=<?=$arr['no']?>'">

<input type='button' value='삭제'
onclick="location.href='board1_qa_del.php?no=<?=$arr['no']?>'">
<?php
}
}
?>
...
<div align='center'>
<table class='type06' border='1' width='80%' align='center'>
<form method='POSt' action='board1_qa_reply.php'>
<tr>
